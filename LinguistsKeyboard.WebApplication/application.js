...
const Greek1 = new Keyboard("Greek (English-style Layout)", "Greek", "greek1", true, "1234567890-=χωερτυ ιοπ[]ασδφθη κλ;'#\\ζξγψβνμ,./".split("").join("|"), "!\"£$%^&*()_+ΧΩΕΡΤΥ ΙΟΠ{}ΑΣΔΦΘΗ ΚΛ:@~ ΖΞΓΨΒΝΜ<>?".split("").join("|"), "\u0301\u0308           ϝ           ς    ϡϙ                 ".split("").join("|"), "             Ϝ                 Ϙ                 ".split("").join("|"));

const Greek2 = new Keyboard("Greek", "Greek", "greek2", true, "1234567890-=;ςερτυθιοπ[]ασδφγηξκλ\u0301'\\<ζχψωβνμ,./".split("").join("|"), "!@#$%^&*()_+: ΕΡΤΥΘΙΟΠ{}ΑΣΔΦΓΗΞΚΛ\u0308\" >ΖΧΨΩΒΝΜ<>?".split("").join("|"), " \u2082\u2083£§¶ ¤      €® ¥                     ©         ".split("").join("|"), "                                                 ".split("").join("|"));
